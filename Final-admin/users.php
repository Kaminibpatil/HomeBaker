        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <h3 class="mb-3" id="totalUsersHeader">Total Users: <span id="totalUsersCount"></span></h3>
...
<script>
    $(document).ready(function() {
        ...
        function fetchUsers() {
            $.ajax({
                url: 'fetch_users.php', // PHP script to fetch data
                method: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    $.each(data, function(index, user) {
                        var row = '<tr>' +
                            ...
                            '<td><button class="btn btn-danger btn-sm delete-btn" data-customer_id="' + user.customer_id + '"><i class="fas fa-trash"></i></button></td>' + // Delete button
                            '</tr>';
        ...
        function deleteUserData(customer_id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        // Refresh user table after deletion
                        fetchUsers();
