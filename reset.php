...
<body style="height:100%">
    ...
    <div class="container">
        <div class="col-lg-4 offset-lg-4 bg-light rounded" id="verify-box">
            <h2 class="text-center mt-2">OTP Verification</h2>
            <div id="verify-error" class="alert text-center"></div>
            <form id="verify-form" role="form" class="p-2">
                <div class="form-group">
                    <p class="text-center">To reset your password, enter the OTP that we have sent to your email.</p>
                </div>
                <div class="form-group text-center">
                    <div class="text-center">
                        <div class="d-inline-block" style="width: 50%;">
                            <input type="tel" name="forgototp" id="forgototp" minlength="6" maxlength="6" class="form-control" pattern="[0-9]{6}" title="Please enter a 6-digit number" oninput="this.value = this.value.replace(/[^0-9]/g, ''); user_otp()">
                        </div>
                    </div>
    ...
    <script>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data == -1) {
                                    ...
                                    alert('OTP matched. Reset password now');
                                    window.location.assign("resetpassword.php?email=" + $("#email").val());
                                }
                            }
                        })
                    }
        ...
        function user_otp() {
            var forgototp = document.getElementById("forgototp").value;

            if (forgototp === "") {
                document.getElementById("forgototp").classList.add("is-invalid");
